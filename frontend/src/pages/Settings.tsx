          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-3">
              ...
              <p className="text-xs text-slate-700 leading-relaxed">
                All shop transactions, stock counts, and ledgers are stored securely in the local PostgreSQL database on this counter machine.
              </p>
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs space-y-1 font-mono text-slate-700">
                <div>pg_dump -U postgres pos_db &gt; backup.sql</div>
              </div>
            </div>
          </div>
